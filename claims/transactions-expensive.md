...
title: Ethereum transactions are expensive # This is the title of the page and the page header.
permalink: claims/transactions-expensive # The URL path for the page you're creating. Keep the `claims/` prefix.
