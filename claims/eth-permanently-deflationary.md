...
title: ETH is permanently deflationary # This is the title of the page and the page header.
permalink: claims/eth-permanently-deflationary # The URL path for the page you're creating. Keep the `claims/` prefix.
