...
title: Staking pools are centralizing the network # This is the title of the page and the page header.
permalink: claims/staking-pools-centralize-network # The URL path for the page you're creating. Keep the `claims/` prefix.
