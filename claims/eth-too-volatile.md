...
title: ETH is too volatile to be used as money # This is the title of the page and the page header.
permalink: claims/eth-too-volatile # The URL path for the page you're creating. Keep the `claims/` prefix.
